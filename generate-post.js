...
const TITLES_JA = [
  "空冷ビートルを買う前に確認したい維持費",
  "販売情報から見る空冷ビートルの選び方",
  "現車確認で見落としたくない空冷VWのポイント",
  "空冷ビートルの故障について購入前に調べること",
  "オーナーの声から考える空冷VWのある暮らし"
];
...
async function generatePost() {
  ...
  const prompt = [
    '出力はJSONのみ。コードブロック禁止。',
    '空冷ビートルをこれから購入したい読者に向けた、購入前の調査記事を作ってください。筆者は現時点で空冷ビートルを所有していません。',
    '本文全体は日本語で260〜380文字、目安は約300文字。5つのセクションを作り、各セクションは45〜80文字程度にしてください。',
    '所有、運転、修理、整備の体験談を書かず、購入前に確認したい費用、現車確認、故障、専門店への質問、オーナーの声を自然につなげてください。確認できない価格、年式、走行距離、修理費、故障原因、店舗名、地域情報は創作しないでください。',
